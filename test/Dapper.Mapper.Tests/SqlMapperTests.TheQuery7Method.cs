    ...
    public partial class SqlMapperTests
    {
        public class TheQuery7Method : SqlMapperTests
        {
            ...
            public void ShouldPassCommandText()
            {
                ...
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: commandText, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: null, commandType: CommandType.Text);
            ...
            public void ShouldPassParameters()
            {
                ...
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: "@foo", param: parameters, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: null, commandType: CommandType.Text);
            ...
            public void ShouldPassCommandTimeout()
            {
                ...
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: commandTimeout, commandType: CommandType.Text);
            ...
            public void ShouldPassCommandType()
            {
                ...
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: null, commandType: commandType);
