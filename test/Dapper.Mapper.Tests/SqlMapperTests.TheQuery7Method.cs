...
namespace Dapper.Mapper.Tests
{
    ...
    {
        public class TheQuery7Method : SqlMapperTests
        {
            ...
            private readonly string[] columnNames = new[] { "FirstId", "SecondId", "ThirdId", "FourthId", "FifthId", "SixthId", "SeventhId" };

            private int rowIndex;

            public TheQuery7Method()
            {
            ...
            public void ShouldPassCommandText()
            {
                ...
                // Act
                this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: commandText, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: null, commandType: CommandType.Text);
            ...
            public void ShouldPassParameters()
            {
                ...
                // Act
                this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: "@foo", param: parameters, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: null, commandType: CommandType.Text);
            ...
            {
                // Act
                this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: null, commandType: CommandType.Text);
            ...
            {
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: string.Empty, param: null, transaction: this.transaction, buffered: false, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: null, commandType: CommandType.Text);
            ...
            {
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: null, commandType: CommandType.Text);
            ...
            public void ShouldPassCommandTimeout()
            {
                ...
                // Act
                this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: commandTimeout, commandType: CommandType.Text);
            ...
            public void ShouldPassCommandType()
            {
                ...
                // Act
                this.connection.Query<First, Second, Third, Fourth, Fifth, Sixth, Seventh>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId,SixthId,SeventhId", commandTimeout: null, commandType: commandType);
