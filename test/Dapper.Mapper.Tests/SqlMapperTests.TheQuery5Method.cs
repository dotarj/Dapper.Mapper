...
namespace Dapper.Mapper.Tests
{
    public partial class SqlMapperTests
    {
        public class TheQuery5Method : SqlMapperTests
        {
            ...
            private readonly string[] columnNames = new[] { "FirstId", "SecondId", "ThirdId", "FourthId", "FifthId" };
            ...
            public void ShouldPassCommandText()
            {
                ...
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth>(sql: commandText, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId", commandTimeout: null, commandType: CommandType.Text);
            ...
            public void ShouldPassParameters()
            {
                ...
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth>(sql: "@foo", param: parameters, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId", commandTimeout: null, commandType: CommandType.Text);
            ...
            public void ShouldPassCommandTimeout()
            {
                ...
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId", commandTimeout: commandTimeout, commandType: CommandType.Text);
            ...
            public void ShouldPassCommandType()
            {
                ...
                // Act
                var result = this.connection.Query<First, Second, Third, Fourth, Fifth>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId,FourthId,FifthId", commandTimeout: null, commandType: commandType);
