    ...
    public partial class SqlMapperTests
    {
        public class TheQuery3Method : SqlMapperTests
        {
            ...
            public void ShouldPassCommandText()
            {
                ...
                // Act
                this.connection.Query<First, Second, Third>(sql: commandText, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId", commandTimeout: null, commandType: CommandType.Text);
            ...
            public void ShouldPassParameters()
            {
                ...
                // Act
                this.connection.Query<First, Second, Third>(sql: "@foo", param: parameters, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId", commandTimeout: null, commandType: CommandType.Text);
            ...
            {
                // Act
                this.connection.Query<First, Second, Third>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId", commandTimeout: null, commandType: CommandType.Text);
            ...
            public void ShouldPassCommandTimeout()
            {
                ...
                // Act
                this.connection.Query<First, Second, Third>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId", commandTimeout: commandTimeout, commandType: CommandType.Text);
            ...
            public void ShouldPassCommandType()
            {
                ...
                // Act
                this.connection.Query<First, Second, Third>(sql: string.Empty, param: null, transaction: this.transaction, buffered: true, splitOn: "SecondId,ThirdId", commandTimeout: null, commandType: commandType);
